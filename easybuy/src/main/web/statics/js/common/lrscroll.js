		...
		return this
				.each(function() {
					var b = false, animCss = o.vertical ? "top" : "left", sizeCss = o.vertical ? "height"
							: "width";
					var c = jq(this), ul = jq("ul", c), tLi = jq("li", ul), tl = tLi
							.size(), v = o.visible;
					if (o.circular) {
					...
					var f = jq("li", ul), itemLength = f.size(), curr = o.start;
					...
					if (o.btnNext)
						jq(o.btnNext).click(function() {
							return go(curr + o.scroll)
						});
					if (o.btnGo)
						jq.each(o.btnGo, function(i, a) {
							jq(a).click(function() {
					...
					function go(a) {
						if (!b) {
							...
							if (!o.circular) {
								jq(o.btnPrev + "," + o.btnNext).removeClass(
										"disabled");
								jq(
...
jQuery(function() {
	jq('#top-menu li').hover(function() {
		jq('ul', this).slideDown(200);
	}, function() {
		jq('ul', this).slideUp(200);
	});
});
...
jQuery(function() {
	jq('.fade').hover(function() {
		jq(this).fadeTo("slow", 0.5);
	}, function() {
		jq(this).fadeTo("slow", 5);
	});
});