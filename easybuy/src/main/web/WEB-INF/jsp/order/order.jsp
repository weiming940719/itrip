    ...
    <table class="table">
        ...
        <c:forEach items="${orderList}" var="temp">
            <tr>
                ...
                <td>
                    <a href="${pageContext.request.contextPath}/order/queryOrderBySerialNumber?serialNumber=${temp.serialNumber}">订单号:${temp.serialNumber}</a>
                </td>
                        ...
                        <c:forEach items="${orderDetailList}" var="detail">
                            <c:if test="${detail.orderId eq temp.id}">
                                <tr>
                                    ...
                                    <td>
                                        <a href="${pageContext.request.contextPath}/product/queryProductDetail?id=${detail.product.id}"
                                           target="_blank">
                                            <img src="${pageContext.request.contextPath}/statics/files/${detail.product.fileName}"
                                                 width="50" height="50">
                                        </a>
                                    </td>
