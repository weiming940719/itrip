            ...
            <tr>
                <td style="font-size:14px; font-family:'宋体'; padding:10px 0 20px 0; border-bottom:1px solid #b6b6b6;">
                    您选定的配送方式为: <font color="#ff4e00">申通快递</font>； &nbsp; &nbsp;您选定的支付方式为: <font
                        ...
                        color="#ff4e00">￥${order.cost}</font>
                </td>
            </tr>
            <tr>
                <td style="padding:20px 0 30px 0; font-family:'宋体';">
                    收款人信息：全称 ${order.address.nextName} ；地址 ${order.userAddress} ； <br/>
                </td>
            </tr>
            <tr>
                <td>
                    <a href="${pageContext.request.contextPath}/index/index">首页</a> &nbsp; &nbsp; <a href="${pageContext.request.contextPath}/index">用户中心</a>
                </td>
            </tr>
        </table>
    </div>
